            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="https://www.e-matchad.com/Sistemkepegawaian/Post/Profile"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                        <li><a href="https://www.e-matchad.com/Sistemkepegawaian/Post"><i class="fa fa-gear fa-fw"></i> Dashboard</a>
                        </li>
                        <li class="divider"></li>
                        <!-- <li><a href="<?php //echo base_url('Dashboard/logout')?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a> -->
                        <li> <a href="https://www.e-matchad.com/login/logout"><i class="fa fa-sign-out fa-fw"></i>Logout</a>
                        </li>
                    </ul>                    
                </li>                
            </ul>
