		...
		<div class="container">
			<div class="row">
                <div class="col-sm-12 col-xs-12">
                    <h4 class="page-head-line">Visi & Misi Perusahaan</h4>
                </div>
            </div>
            <div class="row">             
                <?php
			...
			<div class="row">
				<div id="calendar" class="col-sm-8 col-sm-offset-2">
                    <h3><b>Visi</b></h3>
                    <h4><p align="justify">Terus berkembang sebagai pelopor asia yang bertujuan menjadi berkah bagi semua segmen yang berhubungan dengan kita.</p></h3>
                    <h3><b>Misi</b></h4>
                    <h4><p align="justify">>> Sangat berkomitmen untuk tumbuh dan bekerja sebagai tim untuk memberikan pelayanan terbaik kepada semua segmen.
                    </p></h4>
                    <h4><p align="justify">>> Selalu mengutamakan kepuasan pelanggan, memberi nilai tambah kepada masyarakat, dan berkomitmen terhadap lingkungan.</p></h4>
				</div>
			</div>
		</div>
	</div>
