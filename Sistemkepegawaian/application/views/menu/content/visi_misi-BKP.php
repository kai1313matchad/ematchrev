		...
		<div class="container">
			...
			<div class="row">
				<div id="calendar" class="col-sm-8 col-sm-offset-2">
                    <h2>Visi</h2>
                    <h3>Terus berkembang sebagai pelopor asia yang bertujuan menjadi berkah bagi semua segmen yang berhubungan dengan kita.</h3>
                    <h2>Misi</h2>
                    <h3>>> Sangat berkomitmen untuk tumbuh dan bekerja sebagai tim untuk memberikan pelayanan terbaik kepada semua segmen.
                    </h3>
                    <h3>>> Selalu mengutamakan kepuasan pelanggan, memberi nilai tambah kepada masyarakat, dan berkomitmen terhadap lingkungan.</h3>
				</div>
			</div>
		</div>
	</div>
