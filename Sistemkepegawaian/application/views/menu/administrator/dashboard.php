        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs">
                            <li <?php echo (substr(current_url(),-4) == "Post")? 'class="active"': ''; ?>>
                                <a href="#1" data-toggle="tab">
                                    <h4>Status Akses</h4>
                                </a>
                            </li>
                            <li <?php echo (substr(current_url(),-7) == "Profile")? 'class="active"': ''; ?>>
                            ...
                            <!-- <li <?php echo (($this->session->userdata('user_akses') != '0') AND $this->session->userdata('usg_id')!="1" ? 'style="display:none"':''); ?>>
                                <a href="#7" data-toggle="tab">
                                    <h4>User Access</h4>
                                </a>
                            </li> -->
                            <?php if ($this->session->userdata('usg_id')=='1' OR $this->session->userdata('user_akses')=="0"): ?>
                            <li>
                                <a href="#7" data-toggle="tab">
                                    <h4>User Access</h4>
                                </a>
                ...
                <div class="tab-content">
                    <div <?php echo (substr(current_url(),-4) == "Post")? 'class="tab-pane active"':  'class="tab-pane fade"'; ?> id="1">
                        <br>
                    ...
                    <div <?php echo (substr(current_url(),-7) == "Profile")? 'class="tab-pane active"':  'class="tab-pane fade"'; ?> id="2">
                        <br>
                        <form class="form-horizontal">
                            <div class="form-group">
