        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="tab-content">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <div class="well well-sm">
                                        <?php
                                            if($this->session->userdata('user_akses') == '1'){echo '<i class="fa fa-user-secret fa-lg"></i> Administrator';}
                                            if($this->session->userdata('user_akses') == '2'){echo '<i class="fa fa-user-circle fa-lg"></i> Super';}
                                            if($this->session->userdata('user_akses') == '3'){echo '<i class="fa fa-user fa-lg"></i> Regular';}
                                        ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="5"><br>
