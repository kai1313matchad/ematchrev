                            ...
                            <div class="tab-content" >
                                <div class="tab-pane fade in active" id="pindah_jabatan">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-offset-3 col-sm-2 text-center">
                                            <a href="javascript:void(0)" onclick="appr_lembur()" class="btn btn-block btn-success btn-default btnApr">Approve</a>
                                        </div>
                                        <?php if ($this->session->userdata('usg_id')=="4") { ?>
                                        <div class="col-sm-offset-1 col-sm-2  text-center">
                                            <a href="javascript:void(0)" onclick="appr_lembur()" class="btn btn-block btn-primary btn-default btnApr_hc">Approve HC</a>
                                        </div>
                                        <div class="col-sm-offset-1 col-sm-2 text-center">
                                            <a href="javascript:void(0)" onclick="disappr_lembur()" class="btn btn-block btn-danger btn-default btnApr_hc">Disapprove</a>
                                        </div>
                                        <?php } ?>
                                        <div class="col-sm-offset-1 col-sm-2 text-center">
                                            <a href="javascript:void(0)" onclick="disappr_lembur()" class="btn btn-block btn-danger btn-default btnApr">Disapprove</a>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <script>
        ...
        function pick_lemburedit(id)
        {
            $.ajax({
                ...
                {   
                    ...
                    $("[name='tanggal'], [name='jam_mulai'], [name='jam_berakhir'], [name='keperluan'], #atasan").prop('disabled', false); //added by qoqom
                },
                error: function (jqXHR, textStatus, errorThrown)
                {
                    alert('Error get data from ajax');
        ...
        function pick_lemburapr(id)
        {
            ...
            $.ajax({
                ...
                success: function(data)
                {   
                    ambilatasan(data.id_atasan); //added by qoqom
                    ...
                    $("[name='tanggal'], [name='jam_mulai'], [name='jam_berakhir'], [name='keperluan']").prop('disabled', true); //added by qoqom
                    if (data.acc_atasan == "Tidak") {
                        $(".btnApr_hc,.btnApr").hide();
        ...
        function ambilatasan(id){ //added by qoqom
            var id_at = id;
            $.ajax({
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        if(data.status)
                        {
                            ...
                            lembur(id);     
                            location.reload(); //added by qoqom           
                        }                   
                    },
                    error: function (jqXHR, textStatus, errorThrown)
                    {
