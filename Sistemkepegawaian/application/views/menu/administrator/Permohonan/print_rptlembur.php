...
<body>
    ...
    <script>
        ...
        function check_()
        {
            ...
            $('[name="rptpappr_type"]').text('LAPORAN LEMBUR KARYAWAN');
            gen_tp1(0);
        }
        ...
        {
            $.ajax({
                url : "<?php echo site_url('transaction/Permohonan/gen_laporan_lembur')?>",
                type: "POST",
                ...
                success: function(data)
                {
                    for (var i = 0; i < data['a'].length; i++)
                    {
                        ...
                        var tr = $('<tr>').append(
                            ...
                            $('<td class="text-center">'+moment(data['a'][i]["tanggal"]).format('DD-MMMM-YYYY')+'</td>'),
                            $('<td class="text-center">'+data['a'][i]["jam_mulai"]+'</td>'),
                            $('<td class="text-center">'+data['a'][i]["jam_berakhir"]+'</td>'),
