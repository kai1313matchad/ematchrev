<!-- Page Content -->
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="tab-pane fade in active" id="pindah_jabatan">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <input class="form-control" type="hidden" name="acc_atasan" value="a">
                                            <input class="form-control" type="hidden" name="acc_hc" value="b">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" type="text" name="sisa_cuti" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Jumlah cuti diambil</label>
                                        <div class="col-sm-2">
                                            <input class="form-control" type="text" name="jumlah_cuti" onkeyup="validAngka(this)">
                                        </div>
                                    </div>
                                    <div class="form-group">                              
                                    ...
                                    <div class="form-group" id="penyerahantugas">
                                    ...
                                    <div class="form-group" id="penyerahantugas_apr">
                                        <label class="col-sm-3 control-label">Penyerahan Tugas</label>
                                        <div class="col-sm-7">
                                            <!-- <input class="form-control" type="text" name="penyerahan_tugas"> -->
                                            <input type="text" class="form-control" id="p_tugas_apr" name="penyerahantugas_apr" value="">
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-offset-3 col-sm-2 text-center">
                                <a href="javascript:void(0)" onclick="appr_cuti()" class="btn btn-block btn-success btn-default btnApr">Approve</a>
                            </div>
                             <?php if ($this->session->userdata('usg_id')=="4") { ?>
                            <div class="col-sm-offset-0 col-sm-2 text-center">
                                <a href="javascript:void(0)" onclick="appr_cuti()" class="btn btn-block btn-primary btn-default btnAprhc">Approve HC</a>
                            </div>
                            <div class="col-sm-offset-1 col-sm-2 text-center">
                                <a href="javascript:void(0)" onclick="disappr_cuti()" class="btn btn-block btn-danger btn-default btnAprhc">Disapprove</a>
                            </div>
                            <?php } ?>
                            <div class="col-sm-offset-1 col-sm-2 text-center">
                                <a href="javascript:void(0)" onclick="disappr_cuti()" class="btn btn-block btn-danger btn-default btnApr">Disapprove</a>
                            </div>
                        </div>
                        <br>
                        <br>&nbsp;
    ...
    <script>
        ...
        function dropatasan(id_karyawan)
        {
            $.ajax({
            // url : "<?php //echo site_url('administrator/Dropdown/drop_atasan/')?>"+id_karyawan,
        ...
        function droppenyerahan(id_karyawan)
        {
            $.ajax({
            url : "<?php echo site_url('administrator/Dropdown/drop_karyawan_dept/')?>"+id_karyawan,
            type: "GET",
            dataType: "JSON",
            success: function(data)
                {   
        ...
        function pick_cutiapr(id)
        {
            $.ajax({
                ...
                success: function(data)
                {   
                    ambilatasan(data.id_atasan);
                    // cek_jumlah_cuti(data.id_karyawan);
                    cek_jumlah_cutiapr(data.id_karyawan, data.kuota_cuti, data.jumlah_cuti);
                    ...
                    if (data.acc_atasan == "Tidak") {
                        $(".btnAprhc,.btnApr").hide();
                    }else if(data.acc_atasan == "Ya" && data.acc_hc == ""){
                        $(".btnAprhc").show();
                        $(".btnApr").hide();
                    }else if(data.acc_atasan == "Ya" && data.acc_hc != null){
                        $(".btnAprhc").hide();
                        $(".btnApr").hide();
                    }
                    if (data.acc_hc == "Ya") {
                    ...
                    $("#penyerahantugas").hide();
                    $("#penyerahantugas_apr").show(); 
                    $("#p_tugas_apr").val(data.penyerahan);
                    $('#atasan, #p_tugas_apr').prop("disabled", true);
                    $('[name="jumlah_cuti"]').prop("disabled", true);
                    $('#modal_srch_cuti').modal('hide');
                },
                error: function (jqXHR, textStatus, errorThrown)
                {
        ...
        function ambilatasan(id){
            var id_at = id;
            $.ajax({
            //url : "<?php //echo site_url('administrator/Dropdown/drop_karyawan')?>",
            url : "<?php echo site_url('administrator/Dropdown/ambil_atasan')?>",
            type: "POST",
            data: {id: id_at},
            dataType: "JSON",
            success: function(data)
                {   
                   ...
                   $.each(data, function(i, item) {
                             ...
                             option.text = item.nama_karyawan;
                             select.add(option);
        ...
        function add_cuti()
        {
            ...
            var sisa_cuti = $('[name="sisa_cuti"]').val()*1;
            ...
            if (($('[name="id_karyawan"]').val() !='') && ($('[name="atasan"]').val() !='') && ($('[name="jumlah_cuti"]').val() !='') && (jnscuti !='') && ($('[name="keperluan"]').val() !='')){
                ...
                if (($('[name="jumlah_cuti"]').val()*1) <= sisa_cuti){
                    $.ajax({
        ...
        {   
            var jumlah_cuti = 0;
            var quota_cuti = $('[name="quota_cuti_karyawan"]').val();
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('[name="sisa_cuti"]').val(quota_cuti - jumlah_cuti);
                    // return jumlah_cuti;
                },
                error: function (jqXHR, textStatus, errorThrown)
                {
        ...
        function cek_jumlah_cutiapr(id,kuota,jumlah)
        {   
            var jumlah_cuti = 0;
           ;
            // var quota_cuti = $('[name="quota_cuti_karyawan"]').val();
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('[name="total_cuti"]').val(jumlah_cuti);
                    $('[name="sisa_cuti"]').val( parseInt(kuota) - jumlah_cuti);
                    // return jumlah_cuti;
                },
                error: function (jqXHR, textStatus, errorThrown)
                {
        ...
        function pick_kryedit(id)
        {
            $.ajax({
                ...
                {   
                    ...
                    droppenyerahan(data.id_karyawan);
                    cek_jumlah_cuti(data.id_karyawan);
