                            ...
                            <div class="tab-content" >
                                <div class="tab-pane fade in active" id="pindah_jabatan">
                                    ...
                                    <div class="form-group">                              
                                        ...
                                        <div class="col-sm-8">
                                            <label class="radio-inline"><input type="radio" id="kendaraan_dinas" name="kendaraan_dinas" value="Ya" checked>Ya</label>
                                            <label class="radio-inline"><input type="radio" id="kendaraan_dinas" name="kendaraan_dinas" value="Tidak">Tidak</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-2 text-center">
                                            <a href="javascript:void(0)" onclick="add_ijin()" class="btn btn-block btn-primary btn-default btnAdd">KIRIM</a>
                                        </div>
                                        <div class="col-sm-offset-3 col-sm-2 text-center">
                                            <a href="javascript:void(0)" onclick="update_ijin()" class="btn btn-block btn-primary btn-default btnUpd">Simpan</a>
                                        </div>
                                        <div class="col-sm-offset-3 col-sm-2 text-center">
                                            <a href="javascript:void(0)" onclick="appr_ijin()" class="btn btn-block btn-primary btn-default btnApr">Approve</a>
                                        </div>
                                        <div class="col-sm-offset-3 col-sm-2 text-center">
                                            <a href="javascript:void(0)" onclick="disappr_ijin()" class="btn btn-block btn-primary btn-default btnApr">Disapprove</a>
                                        </div>
                                    </div>
                                    <div class="row">
