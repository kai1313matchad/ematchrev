<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Laporan Record SP</h1>
                    </div>
                </div>
                <div class="row">
    ...
    <script>
        ...
        function print_laporan()
        {
            ...
            window.open ( "<?php echo site_url('administrator/Master/print_rptsp/')?>"+seg1+'/'+seg2+'/'+seg3+'/'+seg4,'_blank');
        }
    </script>
    <!-- Showdata -->
    <script>
        ...
        {        
            if (id==1) {
                table = $('#dtb_laporan').DataTable({
                            ...
                            "order": [],
                            "ajax": {
                                "url": "<?php echo site_url('administrator/Showdata/showrpt_sp')?>",
                                "type": "POST",
                                "data": function(data){
