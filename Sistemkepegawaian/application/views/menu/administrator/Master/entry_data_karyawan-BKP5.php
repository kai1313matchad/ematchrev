        ...
        <div id="page-wrapper" class="bgisi">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="<?php echo 'http://e-matchad.com' ?>"
                            ...
                            <div class="tab-content" >
                                ...
                                <div class="tab-pane fade" id="data_pribadi">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="nomor_telepon" onkeyup="validAngka(this)">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Nomor Kartu Keluarga</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="nomor_kk" onkeyup="validAngka(this)">
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    <script>
        function edit_kry()
        {
            ...
            table = $('#dtb_kry_edit').DataTable({
                ...
                "order": [],                
                "ajax": {
                    "url": "<?php echo site_url('administrator/Searchdata/srch_krybysts_by_id')?>",
                    "type": "POST",
                    "data": function(data){
                        data.sts = '0';
