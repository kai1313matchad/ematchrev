                            ...
                            <div class="tab-content" >
                                <div class="tab-pane fade in active" id="data_pribadi">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <label style="font-style: italic;font-size:10px;color=red;"><font color='red'>Note : HOS=Holding, MAS=Match Surabaya, MAJ=Match Jakarta, KCT=Tritunggal, WPI=Wiperindo, WLN=Wiklan, RCP=eSeLED</font></label>
                                        </div>
                                    <div class="form-group">
        ...
        function pick_kryedit(id)
        {
            $.ajax({
                ...
                {   
                    ...
                    $('[name="jumlah_cuti"]').val(data.jumlahcuti);
