...
<body>
    ...
    <script>
        ...
        function check_()
        {
            ...
            $('[name="rptpappr_type"]').text('LAPORAN SP KARYAWAN');
            gen_tp1(0);
        }
        ...
        {
            $.ajax({
                url : "<?php echo site_url('administrator/Master/gen_laporan_sp')?>",
                type: "POST",
                ...
                success: function(data)
                {
                    for (var i = 0; i < data['a'].length; i++)
                    {
                        var tr = $('<tr>').append(
                            ...
                            $('<td class="text-center">'+moment(data['a'][i]["tgl_sp"]).format('DD-MMMM-YYYY')+'</td>'),
                            $('<td class="text-center">'+data['a'][i]["nama_atasan"]+'</td>'),
                            $('<td class="text-center">'+data['a'][i]["jenis_sp"]+'</td>'),
                            $('<td class="text-center">'+data['a'][i]["keterangan"]+'</td>')
