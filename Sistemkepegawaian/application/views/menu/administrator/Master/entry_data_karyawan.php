<!-- Page Content -->
        <div id="page-wrapper" class="bgisi">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Formulir Data Karyawan</h1>
                    </div>                    
                </div>
                <div class="row">
                    <!-- <div class="col-xs-2">
                    ...
                    <div class="col-sm-2">
                        <a href="<?php echo 'http://localhost/ematch' ?>"
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <ul class="nav nav-tabs" >
                            ...
                            <li>
                                <a href="#data_pribadi" data-toggle="tab">Data Pribadi <?php echo $this->session->userdata('user_level'); ?></a>
                            </li>
                            <!-- <li>
                                <a href="#pindah_jabatan" data-toggle="tab">Pindah Jabatan</a>
                            </li> -->
                        </ul>
                        <form action="#" method="post" class="form-horizontal" id="form_po" name="form_po">
                            <div class="tab-content" >
                                <div class="tab-pane fade in active" id="riwayat_keluarga">
                                ...
                                <div class="tab-pane fade" id="data_pribadi">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-3 text-center">
                                            <h2>Data Pribadi</h2>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="id_branch" value="">
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" id="branch" name="branch" value="" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">NIK</label>
                                        <div class="col-sm-7">
                                            <input class="form-control" type="hidden" name="id_sp">
                                            <input class="form-control" type="hidden" name="id_karyawan" value="<?php echo $this->session->userdata('id_karyawan'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" id="nama_kry" name="nama_kry">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">                              
                                        <label class="col-sm-3 control-label">Jenis Kelamin</label>
                                        <div class="col-sm-8">
                                            <label class="radio-inline"><input type="radio" name="jenis_kelamin" value="Pria" checked>Pria</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="alamat_ktp" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Kota KTP</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="kota_ktp" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="nomor_hp" onkeyup="validAngka(this)" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Nomor Telepon Rumah</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="nomor_telepon" onkeyup="validAngka(this)" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Nomor Kartu Keluarga</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="nomor_kk" onkeyup="validAngka(this)" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Nomor KTP</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="nomor_ktp" onkeyup="validAngka(this)" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" id="nomor_sim_a" name="nomor_sim_a" placeholder="Nomor SIM A">
                                            <input type="checkbox" class="check1" name="jenis_sim" value="SIM B1">SIM B1 
                                            <input type="text" id="nomor_sim_b1" name="nomor_sim_b1" placeholder="Nomor SIM B1">
                                            <input type="checkbox" class="check1" name="jenis_sim" value="SIM C">SIM C 
                                            <input type="text" id="nomor_sim_c" name="nomor_sim_c" placeholder="Nomor SIM C">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="number" name="jumlah_cuti" value='0' readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Nomor HP Dalam Keadaan Darurat</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="nomor_darurat" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Nama Dihubungi Keadaan Darurat</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="nama_darurat" required>
                                        </div>
                                    </div>
                                    <input type="hidden" name="status" value="Aktif">
                                    <br>
                                    <div class="col-sm-8">
                                        <label style="font-size:10px;color=red;"><b><font color='tosca'>* Wajib Diisi</font></label>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-2 text-center">
    ...
    <script>
        ...
        $(document).ready(function()
        {
            ...
            // $('#nama_kry').val($('#nama_kry').val().toUpperCase());
        ...
        {
            $.ajax({
            url : "<?php echo site_url('administrator/Master/ajax_pick_branch/')?>" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
                {   
                    $('[name="branch"]').val(data.BRANCH_NAME);
                },
            error: function (jqXHR, textStatus, errorThrown)
                {
                    alert('Error get data from ajax');
        ...
        function savekaryawan()
        {
            ...
            if ($('[name="id_karyawan"]').val() !=''){
                var a = document.forms["form_po"]["nama_kry"].value;
                var b = document.forms["form_po"]["nama_panggilan"].value;
                var c = document.forms["form_po"]["tempat_lahir"].value;
                var d = document.forms["form_po"]["alamat_ktp"].value;
                var e = document.forms["form_po"]["kota_ktp"].value;
                var f = document.forms["form_po"]["alamat_sekarang"].value;
                var g = document.forms["form_po"]["kota_sekarang"].value;
                var h = document.forms["form_po"]["nomor_hp"].value;
                var i = document.forms["form_po"]["nomor_telepon"].value;
                var j = document.forms["form_po"]["nomor_kk"].value;
                var k = document.forms["form_po"]["nomor_ktp"].value;
                var l = document.forms["form_po"]["agama"].value;
                var m = document.forms["form_po"]["warga_negara"].value;
                var n = document.forms["form_po"]["status_nikah"].value;
                var o = document.forms["form_po"]["pendidikan_terakhir"].value;
                var p = document.forms["form_po"]["nomor_darurat"].value;
                var q = document.forms["form_po"]["nama_darurat"].value;
                if (a == null || a == "") {
                ...
                if (b == null || b == "") {
                    alert("Nama Panggilan Belum diisi !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
                ...
                if (d == null || d == "") {
                    alert("Alamat KTP Belum diisi !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
                if (e == null || e == "") {
                    alert("Kota KTP Belum diisi !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
                if (f == null || f == "") {
                    alert("Alamat sekarang Belum diisi !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
                if (g == null || g == "") {
                    alert("Kota sekarang Belum diisi !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
                ...
                if (i == null || i == "") {
                    alert("Nomor telepon rumah Belum diisi !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
                ...
                if (n == null || n == "") {
                    alert("Status Nikah Belum dipilih !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
                if (p == null || p == "") {
                    alert("Nomor HP dalam keadaan darurat belum diisi !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
                if (q == null || q == "") {
                    alert("Nama yang dihubungi dalam keadaan darurat belum diisi !");
                    Ok=0;
                }else{
                    Ok = 1;
                }
    ...
    <script>
        ...
        { 
            ...
            table = $('#dtb_kry_edit').DataTable({
                ...
                "order": [],                
                "ajax": {
                    "url": "<?php echo site_url('administrator/Searchdata/srch_kryby_id_kry')?>",
                    "type": "POST",
                    "data": function(data){
                        data.sts = '0';
                        data.brch = $('[name="branch"]').val();
                        data.id_kry = $('[name="id_karyawan"]').val();
                        data.chk = '0';
                    },
                },
                "columnDefs": [
        ...
        function pick_kryedit(id)
        {
            ...
            $.ajax({
                ...
                {   
                    ...
                    $('[name="id_branch"]').val(data.id_branch);
                    ...
                    $('[name="nomor_telepon"]').val(data.telepon_rumah);
                    ...
                    $('[name="nomor_sim_a"]').val(data.nomor_sim_a);
                    $('[name="nomor_sim_b1"]').val(data.nomor_sim_b1);
                    $('[name="nomor_sim_c"]').val(data.nomor_sim_c);
