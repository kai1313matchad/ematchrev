...
<!-- Page Content -->
        <div id="page-wrapper" class="bgisi">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Pembayaran Pinjaman Koperasi Karyawan</h1>
                    </div>                    
                </div>
                <div class="row">
                    <div class="col-sm-2">
                        <a href="javascript:void(0)" onclick="edit_pembayaran()" class="btn btn-block btn-primary">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <ul class="nav nav-tabs" >
                            <li class="active">
                                <a href="#pindah_jabatan" data-toggle="tab">Pembayaran Pinjaman</a>
                            </li>
                        </ul>
                                ...
                                <div class="tab-pane fade in active" id="pindah_jabatan">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-3 text-center">
                                            <h2>Pinjaman Koperasi Karyawan</h2>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <input class="form-control" type="hidden" name="id_pinjaman">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control curr-num chgcount" type="text" name="total_pinjaman" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control curr-num chgcount" type="text" name="jangka_angsuran" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon curr">Rp</span>
                                                <input class="form-control curr-num chgcount" type="text" name="jumlah_angsuran" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <label class="radio-inline"><input type="radio" name="status_pinjaman" value="Belum" checked>Belum Lunas</label>
                                            <label class="radio-inline"><input type="radio" name="status_pinjaman" value="Lunas">Pinjaman Lunas</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Tanggal Pembayaran Pinjaman</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Pembayaran Angsuran ke</label>
                                        <div class="col-sm-2">
                                            <select id="angsuran" name="angsuran" class="form-control" onchange="hitung_sisa_angsuran()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control curr-num chgcount" type="text" name="bunga_pinjaman" value=1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Jumlah Angsuran + Bunga</label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon curr">Rp</span>
                                                <input class="form-control curr-num chgcount" type="text" name="total_angsuran" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon curr">Rp</span>
                                                <input class="form-control curr-num chgcount" type="text" name="sisa_angsuran" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-2 text-center">
                                            <a href="javascript:void(0)" onclick="add_pembayaran()" class="btn btn-block btn-primary btn-default">Tambah</a>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <script>
        ...
        function hitung_sisa_angsuran() {
          var jumlah_angsuran = $('[name="jumlah_angsuran"]').val();
          var jumlah_pinjaman = $('[name="total_pinjaman"]').val();
          var angsuran = $('[name="angsuran"]').val();
          var jumlah_sisa_angsuran = jumlah_pinjaman - (jumlah_angsuran * angsuran);
          $('[name="sisa_angsuran"]').val(jumlah_sisa_angsuran);
          hitung_angsuran_bunga();
        }

        function hitung_angsuran_bunga() {
          var jumlah_angsuran = $('[name="jumlah_angsuran"]').val();
          var bunga_pinjaman = $('[name="bunga_pinjaman"]').val();
          var angsuran = $('[name="angsuran"]').val();
          var jumlah_angsuran = (jumlah_angsuran * 1) + ((jumlah_angsuran * bunga_pinjaman) / 100);
          $('[name="total_angsuran"]').val(jumlah_angsuran);
        }
        ...
        function add_pembayaran()
        {
            if ($('[name="id_karyawan"]').val() !=''){
                $.ajax({
                        url : "<?php echo site_url('administrator/Master/ajax_tambahpembayaran')?>",
                        type: "POST",
                        data: $('#form_po').serialize(),
                        dataType: "JSON",
                        success: function(data)
        ...
        function pembayaran_pinjaman()
        {
            table = $('#dtb_mutasi').DataTable({
                ...
                "order": [],                
                "ajax": {
                    "url": "<?php echo site_url('administrator/Master/ajax_pembayaran')?>",
                    "type": "POST",                
                },
                "columnDefs": [
                { 
        ...
        function del_pembayaran(id)
        {
            ...
            {                
                $.ajax({
                    url : "<?php echo site_url('administrator/Master/ajax_del_pembayaran/')?>"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
