<?php
	...
	class Dropdown extends CI_Controller
	{
		...
		//added by pak rudy s
		public function drop_karyawan_dept($id_karyawan)
		{
			$data = $this->dropdown->getdrop_karyawan_dept($id_karyawan);
			echo json_encode($data);
		}

		public function drop_atasan($id_karyawan)
		{
			$data = $this->dropdown->getdrop_atasan($id_karyawan);
			echo json_encode($data);
		}
