	...
	class Permohonan extends CI_Controller
	{
		...
		public function ajax_cuti($id)
		{
			...
			foreach ($list as $dat) {
				...
				$row[] = $dat->acc_hc;
				if ($dat->acc_atasan==''){
					$row[] = '<a href="javascript:void(0)" title="Hapus Data" class="btn btn-sm btn-danger btn-responsive" onclick="del_cuti('."'".$dat->id_cuti_karyawan."'".')"><span class="glyphicon glyphicon-remove"></span></a>';
				}else{
					$row[] ='';
				}
	    ...
	    public function ajax_ijin($id)
		{
			...
			foreach ($list as $dat) {
				...
				$row[] = $dat->acc_hc;
				if ($dat->acc_atasan==''){
					$row[] = '<a href="javascript:void(0)" title="Hapus Data" class="btn btn-sm btn-danger btn-responsive" onclick="del_ijin('."'".$dat->id_ijin_karyawan."'".')"><span class="glyphicon glyphicon-remove"></span></a>';
				}else{
					$row[] ='';
				}
		...
		public function ajax_lembur($id)
		{
			...
			foreach ($list as $dat) {
				...
				$row[] = $dat->acc_hc;
				if ($dat->acc_atasan==''){
					$row[] = '<a href="javascript:void(0)" title="Hapus Data" class="btn btn-sm btn-danger btn-responsive" onclick="del_lembur('."'".$dat->id_lembur_karyawan."'".')"><span class="glyphicon glyphicon-remove"></span></a>';
				}else{
					$row[] ='';
				}
