<?php
	...
	class Dt_showrptijin extends CI_Model 
	{
		...
		{	
			...
			{
				$this->db->where('a.tgl_mulai >=', $this->input->post('tgl_start'));
        		$this->db->where('a.tgl_mulai <=', $this->input->post('tgl_end'));  
			}
			$this->db->select('b.nama_karyawan,a.tgl_mulai,a.tgl_berakhir,a.keperluan,c.nama_karyawan as nama_atasan,a.acc_atasan,a.acc_hc');
