<?php
	...
	class Dt_showrptsp extends CI_Model 
	{
		var $table = 'surat_peringatan a';
		var $column_order = array(null,'b.nama_karyawan','a.tgl_sp','c.nama_atasan','a.jenis_sp','a.keterangan');
		var $column_search = array('b.nama_karyawan','a.tgl_sp','c.nama_atasan','a.jenis_sp','a.keterangan');
		...
		{	
			...
			$this->db->select('b.nik,b.nama_karyawan,a.tgl_sp,a.keterangan,c.nama_karyawan as nama_atasan,a.jenis_sp');
