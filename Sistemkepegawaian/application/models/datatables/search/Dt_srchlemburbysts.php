<?php
	...
	class Dt_srchlemburbysts extends CI_Model 
	{
		...
		var $column_order = array(null,'b.nik','b.nama_karyawan','c.nama_karyawan','tanggal','keperluan','jam_mulai','jam_berakhir','acc_atasan','acc_hc');
		var $column_search = array('b.nik','b.nama_karyawan','c.nama_karyawan','tanggal','keperluan','jam_mulai','jam_berakhir','acc_atasan','acc_hc');
		...
		private function _get_datatables_query($id,$brc)
		{
			...
			$this->db->order_by('a.id_lembur_karyawan','desc');
