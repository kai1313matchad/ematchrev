<?php
	...
	class Dt_srchcutibysts extends CI_Model 
	{
		...
		{
			$this->db->select('a.id_cuti_karyawan,b.nik,b.nama_karyawan as nama_karyawan,a.tgl_mulai,a.tgl_berakhir,a.acc_atasan,a.acc_hc, c.nama_karyawan as atasan');
			$this->db->join('karyawan b','b.id_karyawan = a.id_karyawan','left');
			$this->db->join('karyawan c','c.id_karyawan = a.id_atasan','left');
			// $this->db->where('cuti_sts',$id);
			...
			$this->db->order_by('a.id_cuti_karyawan','desc');
