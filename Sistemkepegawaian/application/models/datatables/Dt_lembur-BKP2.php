<?php
	...
	class Dt_lembur extends CI_Model 
	{
		...
		var $column_order = array(null,'a.id_karyawan','b.nama_karyawan','b.nik','tgl_mulai','tgl_berakhir','jam_mulai','jam_berakhir','acc_atasan','acc_hc');
		var $column_search = array('a.id_karyawan','b.nama_karyawan','b.nik','tgl_mulai','tgl_berakhir','jam_mulai','jam_berakhir','acc_atasan','acc_hc');
