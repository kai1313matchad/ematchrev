<?php
	...
	class M_crud extends CI_Model
	{
	    ...
	    public function getcuti_kar($id){
	    	$this->db->select("b.nik, a.id_cuti_karyawan,a.id_karyawan,a.id_atasan, b.nama_karyawan, a.tgl_mulai, a.tgl_berakhir, a.jumlah_cuti, b.jumlah_cuti as kuota_cuti, a.jenis_cuti, keperluan, penyerahan, acc_atasan, acc_hc, cuti_sts");
	    	$this->db->from("cuti_karyawan_hc a");
	    	$this->db->join("karyawan b","b.id_karyawan = a.id_karyawan");
	    	$this->db->where("a.id_cuti_karyawan", $id);
	    	$query = $this->db->get();
	    	return $query->row();
	    }
