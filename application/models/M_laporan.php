...
// GROUP BY kpim_karyawan.id_karyawan');
    ...
    $query = $this->db->query(
        'SELECT b.nama_karyawan, b.email, akses.nama_akses, b.id_karyawan, b.harikerja, b.jabatannya,group_concat(distinct dept.nama_dept SEPARATOR ", ") as deptini,dept.id_cab,
    COUNT(DISTINCT tgl) as jumlah
    ...
    COUNT(DISTINCT tgl) as jumlah,max(tgl_kirim) as terakhir
    FROM kpim_karyawan a RIGHT JOIN karyawan b ON b.id_karyawan = a.id_karyawan 
    AND a.tgl BETWEEN "'.$tglstart.'" and "'.$tglend.'"
    AND a.sdh_send = 1
    join dept on find_in_set(dept.id_dept, b.dept) 
