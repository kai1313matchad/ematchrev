...
<!-- 
		...
		<div class="row jarak">
			<div class="col-lg-4">
				<div style="font-size: 20px">Departement RCP:</div>
			</div>

			<div class="col-lg-8">
				<div class="checkbox">
				  <label><input id="allrcp<?php echo $u->id_karyawan ?>" onclick="pilihdeptrcp(<?php echo $u->id_karyawan ?>)" type="checkbox" value="">Pilih semua Dept. RCP</label>
				</div>
			</div>
			...
			<div class="col-lg-8 col-lg-offset-4">
				 <div class="col-sm-2" style="padding-right: 90px">
					<div class="checkbox">
					  <label><input class="pilihandept rcp<?php echo $u->id_karyawan ?>" type="checkbox" name="dept[]" value="36" <?php if(in_array("36", $id_deptku)) {echo 'CHECKED';}; ?>>IT</label>
					</div>
					<div class="checkbox">
					  <label><input class="pilihandept rcp<?php echo $u->id_karyawan ?>" type="checkbox" name="dept[]" value="32" <?php if(in_array("32", $id_deptku)) {echo 'CHECKED';}; ?>>HC</label>
					</div>
					<div class="checkbox">
					  <label><input class="pilihandept rcp<?php echo $u->id_karyawan ?>" type="checkbox" name="dept[]" value="33" <?php if(in_array("33", $id_deptku)) {echo 'CHECKED';}; ?>>GA</label>
					</div>
					<div class="checkbox">
					  <label><input class="pilihandept rcp<?php echo $u->id_karyawan ?>" type="checkbox" name="dept[]" value="31" <?php if(in_array("31", $id_deptku)) {echo 'CHECKED';}; ?>>Marketing </label>
					</div>	
				...
				<div class="col-sm-2" style="padding-right: 90px">
					<div class="checkbox">
					  <label><input class="pilihandept rcp<?php echo $u->id_karyawan ?>" type="checkbox" name="dept[]" value="34" <?php if(in_array("34", $id_deptku)) {echo 'CHECKED';}; ?>>Finance</label>
					</div>
					<div class="checkbox">
					  <label><input class="pilihandept rcp<?php echo $u->id_karyawan ?>" type="checkbox" name="dept[]" value="35" <?php if(in_array("35", $id_deptku)) {echo 'CHECKED';}; ?>>Accounting</label>
					</div>
					<div class="checkbox">
					  <label><input class="pilihandept rcp<?php echo $u->id_karyawan ?>" type="checkbox" name="dept[]" value="37" <?php if(in_array("37", $id_deptku)) {echo 'CHECKED';}; ?>>Secretary</label>
					</div>
				</div>
			</div>
		</div>
	...
	<script>
		...
		function pilihdeptrcp(a){
		    if ($('#allrcp' + a).prop('checked')) {
		    	$('.rcp' + a).prop('checked', true);
		    	}
		    else {
		        $('.rcp' + a).prop('checked', false);
		    }
		}		
