...
<?php date_default_timezone_set('Asia/Jakarta'); ?>
	            ...
	            <ul class="nav navbar-nav">
                    ...
                    <li class="active dropdown">
	                    ...
	                    <ul class="dropdown-menu">
	                    	<li><a href="<?php echo base_url(); ?>reportkaryawan/rata2">Grafik Nilai Rata-Rata Semua karyawan</a></li>
	                    </ul>
                    </li>
	...
	<div class="container-fluid" style="max-width: 600px; height: auto; background-color: black; color: white; border:solid 4px maroon; border-radius: 15px;">
		<div class="row"> 
			<div class="col-sm-12 text-center" style="padding-top: 10px">Grafik Report Karyawan</div>
		</div>
