...
<html lang="en">
<head>
<title>Folder Factsheet | Holding Center</title>
...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header"><span style="color: maroon">Folder</span> Factsheet</h3>
			<p class="agileits_dummy_para">"Dapat melihat seluruh file atau lihat file berdasarkan periode tanggal"</p>
			<br><br>
			

			<form id="form_laporan" action="<?php echo base_url();?>factsheet/laporantgl" method="POST">
				<div class="row">
			...
			<br>		
			<a href="<?php echo base_url() ?>factsheet/laporan"><button class="btn btn-primary"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Tampilkan Semua Laporan</button></a><br><br>
			<?php } ?>
					...
					<table id="dataTables" class="display table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
				        <thead>
				            <tr>
				                ...
				                <th style="text-align: center; color: black">ID Factsheet</th>
				    		    <th style="text-align: center; color: black">Nama PIC</th>
				                <th style="text-align: center; color: black">Tanggal dan Jam Upload</th>
				                <th style="text-align: center; color: black">Lokasi File</th>
				                <th style="text-align: center; color: black">Jenis Proyek</th>
				                <th style="text-align: center; color: black">Jenis Factsheet</th>
				                				                <!-- <th style="text-align: center; color: black">Vendor</th> -->
				                <th style="text-align: center; color: black">Foto Siang/Malam</th>
				                <th style="text-align: center; color: black">Alamat Factsheet</th>
				                <!-- <th style="text-align: center; color: black; padding: 100px">Alamat Via</th> -->
				                <th style="text-align: center; color: black">Detail Keterangan</th>
						...
						<tbody >
									...
									?>
										<tr>
											...
											<td style="text-align: center; color: black"><?php echo $u->id_factsheet ?></td>
											...
											<td style="text-align: center; color: black"><?php echo $u->jenis_factsheet ?></td>
											...
											<td style="text-align: center; color: black;">
												<form id="Detail" action="<?php echo base_url();?>factsheet/detail/<?php echo $u->id_factsheet ?>" method="POST">
												...
												<br>
												<button data-toggle="modal" data-target="#modalHapus<?= $u->id_factsheet ?>" type="button" class="btn btn-danger btn-sm col-md-12">
												...
												<!-- Modal hapus -->
												<div class="modal fade" id="modalHapus<?php echo $u->id_factsheet ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="padding-top: 100px;">
												  <div class="modal-dialog modal-lg" role="document">
												    <div class="modal-content">
												      ...
												      <div class="modal-footer">
															<form id="form_kpim" method="POST" action="<?php echo base_url();?>factsheet/hapuslaporan/<?php echo $u->id_factsheet?>">
