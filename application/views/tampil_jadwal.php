	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
	               <!--  <li><a href="<?php echo base_url(); ?>kpimmingguan">KPIM Mingguan</a></li>
	                ...
	                <li class="active"><a href="#">Jadwal Pengumpulan Terakhir KPIM Plan Next</a></li>
...
<div class="container">
	<div class="background">
		<h1 style="padding-top: 20px; color: green"><center>Jadwal Pengumpulan Terakhir KPIM Plan Next (Subordinate)</center></h1><br><br>
	...
	<div class="table-responsive"  style="text-align: center;">
		  ...
		  <tr>
		    ...
		    <td class="tg-yw4l">Match Advertising SBY</td>
		  ...
		  <tr>
		    ...
		    <td class="tg-yw4l">Match Advertiing JKT</td>
		    <td class="tg-2s1i" style="width: 110px"></span></td>
		    <td class="tg-mtwr"></td>
		    <td class="tg-4hfa"></td>
		    <td class="tg-r61r"></td>
