...
<body class="nilai2 semua">
	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
                    ...
                    <li class="active dropdown">
	                    <a href="#" class="dropdown-toggle active" data-toggle="dropdown">Nilai Rata-Rata Karyawan
	...
	<div class="container jarak">
		...
		<center><h2>Laporan Nilai Akhir / Nilai Rata-rata KPIM Karyawan</h2></center>
		<br><center><h4 style="font-style: italic;color:red">*Pilih tanggal periode terlebih dahulu</h4></center>
						...
						<?php if (empty($tglstart)){
							echo "<tr>
								<td colspan='8' align='center' style='color:red'>
										*Pilih tanggal periode terlebih dahulu
