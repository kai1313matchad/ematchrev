									...
									?>
										<tr>
											...
											<td style="text-align: center; color: black;">
												...
												<br>
												<button data-toggle="modal" data-target="#modalHapus<?= $u->id_penerangan ?>" type="button" class="btn btn-danger btn-sm col-md-12">
												...
												<!-- Modal hapus -->
												<div class="modal fade" id="modalHapus<?php echo $u->id_penerangan ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="padding-top: 100px;">
												  <div class="modal-dialog modal-lg" role="document">
												    <div class="modal-content">
												      ...
												      <div class="modal-footer">
															<form id="form_kpim" method="POST" action="<?php echo base_url();?>penerangan/hapuslaporan/<?php echo $u->id_penerangan?>">
