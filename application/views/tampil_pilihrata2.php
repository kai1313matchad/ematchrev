...
<?php date_default_timezone_set('Asia/Jakarta'); ?>
	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
                    ...
                    <li class="active dropdown">
	                    <a href="#" class="dropdown-toggle active" data-toggle="dropdown">Grafik Nilai Rata-Rata Semua karyawan <span class="caret"></span></a>
	                ...
	                <?php } ?>
                     ...
                     <?php 
					if ($this->session->userdata('id_dept') == 2 || $this->session->userdata('level') == 1 || $this->session->userdata('level') == 5 ) { ?>
	...
	<div class="container-fluid" style="max-width: 600px; height: auto; background-color: black; color: white; border:solid 4px orange; border-radius: 15px;">
		<div class="row"> 
			<div class="col-sm-12 text-center" style="padding-top: 10px">Grafik Nilai Rata-Rata Semua Karyawan</div>
		</div>
