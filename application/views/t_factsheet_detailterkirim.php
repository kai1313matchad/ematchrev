...
<html lang="en">
<head>
<title>Detail Tahapan Factsheet </title>
...
Sidoarjo - East Java, 61257</p>
										...
										<ul class="nav navbar-nav">
											...
											<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Factsheet <span class="caret"></span></a>
												<ul class="dropdown-menu">
													...
													<li><a class="hvr-bounce-to-bottom" href="<?php echo base_url() ?>factsheet/terkirim">Fatcsheet Tersimpan</a></li>          
												</ul>
											</li>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header">Detail Factsheet <span>Tersimpan </span></h3>
			<p class="agileits_dummy_para"><a href="<?php echo base_url(); ?>factsheet/terkirim"><button class="btn btn-danger" style="width: 200px"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Kembali</button></a></p>
			<br><br>
		<div id="ygdiprint">
			...
			<?php 
				...
				<?php $tgl = $posting->tanggal ;?>
					...
					<div class="col-md-12">
						<center>
							<span class="agileinfo_header" style="font-size: 25px; text-decoration: underline; font-weight: bold;"><?php echo $posting->reklame ?></span>
							<br>
							<span style="font-weight: bold;">
								No.FS/<?php echo date('mY')?>/<?php echo $posting->id_factsheet ?>
							</span>
						</center>
					...
					<h4><text style="color: #0b3789">Lokasi File Perusahaan &nbsp:&nbsp <?php echo $posting->perusahaan ?></text></h4>
					...
					<h4><text style="color: #0b3789">Status Foto &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp <?php echo $posting->status_foto ?></text></h4>
					<h4><text style="color: #0b3789">Jenis Factsheet &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp <?php echo $posting->jenis_factsheet ?></text></h4>						
					...
					<p style="font-style: italic;">Keteragan &nbsp&nbsp&nbsp&nbsp: <?php echo $posting->ket ?></p>
...
<div class="footer">
		<div class="container">
			...
			<p class="agileits_dummy_para" style="color: white">© 2019 Update Factsheet . All Rights Reserved By <a href="https://www.match-advertising.com/"><span style="color: #f25252">Holding</span> <span style="color: #5292f9">Center</span></a></p>
				<!-- <p class="agileits_dummy_para">Halaman detail laporan Fecovering.</p> -->
				<!-- <div class="news-w3l">
