									...
									<nav>
										<ul class="nav navbar-nav">
											...
											<!-- <li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Laporan <span class="caret"></span></a>
												<ul class="dropdown-menu">
													<li><a class="hvr-bounce-to-bottom" href="<?php echo base_url() ?>pondasi/laporan">Laporan pondasi</a></li>
												</ul>
											</li> -->
									...
									?>
										<tr>
											...
											<td style="text-align: center; color: black;">
												...
												<br>
												<button data-toggle="modal" data-target="#modalHapus<?= $u->id_pondasi ?>" type="button" class="btn btn-danger btn-sm col-md-12">
												...
												<!-- Modal hapus -->
												<div class="modal fade" id="modalHapus<?php echo $u->id_pondasi ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="padding-top: 100px;">
												  <div class="modal-dialog modal-lg" role="document">
												    <div class="modal-content">
												      ...
												      <div class="modal-footer">
															<form id="form_kpim" method="POST" action="<?php echo base_url();?>pondasi/hapuslaporan/<?php echo $u->id_pondasi?>">
