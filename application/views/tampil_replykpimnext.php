...
<div class="container">
	<div class="background">
		<h1 style="padding-top: 20px"><center>Notifikasi - KPIM Plan Next</center></h1><br><br>
...
<div class="row">
		...
		<div class="row ">
		 <div class="col-sm-4"></div>
		  ...
		  <a class= "btn btn-primary" style="font-family: 'Exo 2', sans-serif; margin-top:5px" href="<?php echo base_url(); ?>index"><h7><span class="glyphicon glyphicon-home"></span> Home Holding Center</h7></a>
		  </div>
		</div>
