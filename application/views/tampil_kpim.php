...
<style type="text/css">
	...
	/*added by qoqom*/
	#rentang-tanggal2 {margin-left: -15px;}
...
<div class="row">
		...
		<?php if ($valid == 'ada') { ?>
			...
			<div class="row">
				<div class="col-lg-3 text-left" style="margin-left: 5px">
			...
			<div class="row">				
				<div class="col-md-3">
					...
					<select id="pilihdept" name="tgs_dept" class="form-control" required oninvalid="this.setCustomValidity('Pilih terlebih dahulu')" oninput="setCustomValidity('')" onchange="isigoal()">
					...
					<!-- disabled by qoqom -->
					<!-- <div id="jdl_konten" class="text-left col-md-3" style="margin:0px 0 0 5px; display: none">
					Goal/Pekerjaan :
					</div> -->
					<!-- div input group disabled by qoqom -->
					<!-- <div class="input-group"> -->
					<!-- edited by qoqom -->
					<div class="form-group">
						<div class="col-md-12 col-sm-12 col-lg-12 input-group">
							<label class="pull-left">Goal/Referensi : </label>
							<select class="form-control" style="max-width: : 240px;" id="konten"  name="goals" style="display: none" required="" onchange="isilevel()">
							...
							<span class="input-group-btn">
								<button type="button" onclick="add_goal()" id="btn_addgoal" style="font-family: 'Exo 2', sans-serif; " title="Tambah Goal" name="input" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus"></span></button>	
							</span>
						</div>	
					</div>
						<script>
							$("#konten").select2ToTree();
						</script>
				        <!-- <span class="input-group-btn">
				...
				<script>
					...
					function isigoal()
			        {     
			        	//bukadept disabled by qoqom
			        	// bukakdept();       
			        	//added by qoqom
			        	var id_depart = $('#pilihdept').val();
			        	$('#pilihdept_tambah').val(id_depart);
			        	$('#konten').prop('disabled', false);
			            ...
			            $.ajax({
			                ...
			                { 
			                    ...
			                    //added by qoqom
			                    console.log(data);
			                    $("#konten").select2ToTree({treeData: {dataArr:data}, maximumSelectionLength: 3});
			                    $("#konten").select2ToTree();
			                    $("#pilihgoalreferensi2").select2ToTree({treeData: {dataArr:data}, maximumSelectionLength: 3});
			        ...
			        function isilevel(id){
						...
						$.ajax({
				                ...
				                success: function(data)
				                {   
				                	console.log(data.id_bobot);
				                    $('#konten').val(data.id_bobot);
				    ...
				    function check_deadline(id){
			      		$.ajax({
			      			...
			      			success: function(data){
			      				...
			      				$("#datetimepicker4").datetimepicker({ minDate: 0, maxDate: new Date(tgl), format: "YYYY-MM-DD" });
			      			}
			      		});
			      	}
				    //add by qoqom
				...
				<!-- add by qoqom untuk tambah goal -->
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
					        ...
					        <form name="form_tambah_goal" id="form_tambah_goal">
					        	<!-- edit by qoqom -->
					        <input type="hidden" name="pilihdept_tambah" id="pilihdept_tambah">	
					        <div class="modal-body" style="background-color: #70a8ff;">
					        		...
					        		<div class="form-group">
					        			...
					        			<div class="col-xs-9 col-sm-9">
					        				<!-- <div class="input-group"> -->
								        		...
								        		<select style="width: 100%" class="form-control pull-left" id="pilihgoalreferensi2" name="pilihgoalreferensi2" onchange="pickGoals2()">
					        	...
					        	<div class="row">
					        		...
					        		<div class="col-sm-3"> 
										<label class="pull-left">Nama Goal :</label>
									</div>
					        		<div class="col-xs-9 col-sm-9">
						        		<div class="form-group">
						        ...
						        <div class="row">
						        	<div class="col-sm-3"> 
										<label class="pull-left">Jenis Goal :</label>
									</div>
									<div id="form_jns_goal" class="col-sm-9" style="padding-bottom: 10px">
										<input type="radio" id="jenis_goal" name="jenis_goal" value="Pasti"> Pasti</input>&nbsp;&nbsp;
										<!-- deleted by qoqom -->
										<!-- <input type="radio" name="jenis_goal" value="Plan">Plan</input> -->
										<input type="radio" id="jenis_goal" name="jenis_goal" value="Rutin"> Rutin</input>
									</div>
						        </div>
										...
										<!-- <div class="form-group"> -->
											<div class="col-sm-6">
												<div class='input-group date tgls' id='tgl_start'>     
													...
													<input type='text' id="tgl_start2" class="form-control input-group-addon" name="tgl_start2" placeholder="Tgl Start" >
												</div>	
											</div>
						        ...
						        <div class="row">
						        	<div class="col-sm-3"> 
						        		<label class="pull-left">Nilai Goal :</label>
						        	</div>
				...
				<script>
					function bukakdept(iddept){
						...
						$.ajax({
							// url : "<?php //echo site_url('karyawan/ambildatabobotkpim/')?>",
							//edited by qoqom
			                url : "<?php echo site_url('karyawan/ambildatamaster_bobot/')?>",
			                type: "POST",
			                data: {pilihdept:$('#pilihdept').val()},
			                dataType: "JSON",
			                success: function(data)
					...
					{
						var id_depart2 = $('#pilihdept_tambah').val();
						var nama_goal2 = $('#nama_goal').val();
						var pilihgoal2 = $('#pilihgoalreferensi2').val();
						var jenisgoal2 = $('input[name="jenis_goal"]:checked').val();
						var nilaibobot2 = $('#nilai_bobot').val();
						var tgl_start2 = $('#tgl_start2').val();
						var tgl_end2 = $('#tgl_end').val();
						$.ajax({
					                url : "<?php echo site_url('karyawan/simpanbobot2')?>",
					                type: "POST",
					                data: {pilihdept_tambah: id_depart2, nama_goal: nama_goal2, pilihgoalreferensi2: pilihgoal2, jenis_goal: jenisgoal2, nilai_bobot: nilaibobot2, tgl_start: tgl_start2, tgl_end: tgl_end2},
					                // data: {pilihdept:$('#pilihdept').val()},
					                dataType: "JSON",
					                success: function(data)
					                {
				...
				<!--lokasi-->
		<!-- Update Sistem Halaman Input KPIM Mingguan (Marketing)  -->
					<textarea class="form-control jarak" rows="1" cols="20" placeholder="Nama Produk/Titik Lokasi Dijual (Marketing)" name="lokasi" id="lokasi" style="margin:0px 0 0 5px; display: none"></textarea>
				</div>
		...
		<!-- Update Sistem Halaman Input KPIM Mingguan (Marketing)  -->
					<div class="input-group">
						...
						<input class="form-control num" type="text" rows="4" cols="20" placeholder="Target Produk/Titik Dijual (Marketing)" name="omset" id="omset" style="margin:0px 0 0 5px; display: none">
					</div>
				</div>
				...
				<table id="dataTables" class="table table-bordered table-hover table-striped">
					...
					foreach($bulan as $bln){
						...
						foreach($hari as $hr){
							...
							<?php 
							if ($u->tgl == date('Y-m-d') && $u->jenis_bobot=="Rutin") {echo 'style="background: linear-gradient(-20deg,#20b189,#456f9c);
							...
							if ($u->tgl > $u->tgl_end && $u->jenis_bobot=="Pasti") {
								echo 'style="background-color: #cf2323; color: white;"';
							}elseif ($u->tgl == date('Y-m-d') && $u->jenis_bobot=="Pasti") {
								echo 'style="background: linear-gradient(-20deg,#20b189,#456f9c);
							    background-image: linear-gradient(-20deg, rgb(32, 177, 137), rgb(69, 111, 156));
							    background-position-x: initial;
							    background-position-y: initial;
							    background-size: initial;
						...
						>
							...
							<td style=" max-width: 100px; "><?php echo $no; ?></td>
							<td style=" max-width: 150px; word-wrap: break-word; overflow: auto;"><?php echo $u->nama ?></td>
							<td style=" max-width: 150px; word-wrap: break-word; overflow: auto;"><?php echo $u->jenis_bobot ?></td>
						   ...
						   <!-- <?php if ($u->id_dept =='5'){ 
							...
							<td width="150px">
								<button id="editbutton<?php echo $u->id ?>" data-toggle="modal" data-target="#myModal<?php echo $u->id ?>" type="button" class="btn btn-primary btn-sm" 
			                    ...
			                    <button type="button" class="btn btn-danger btn-sm" data-target="#myModalhapus<?php echo $u->id ?>" data-toggle="modal" name="input"  style="font-family: 'Exo 2', sans-serif; text-transform: capitalize;"> <span class="glyphicon glyphicon-trash"></span> Hapus
								</button>
						...
						<form id="form_kpim" action="<?php base_url();?>kpimmingguan/update/<?php echo $u->id ?>" method="POST">
							...
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="col-lg-10">
										<select style="width: 275px" id="kontenedit<?php echo $u->id ?>" class="form-control" name="goaledit" required>
											<option value="">--- Pilih Goal Referensi ---</option>
											<!-- edited by qoqom -->
										<?php //$datadept = $this->M_karyawanku->getbobot($u->tgs_dept)->result(); ?>
										<?php //$datadept = $this->M_karyawanku->getbobot_($u->tgs_dept)->result(); ?>
							...
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="col-lg-10 ">
										<textarea class="form-control" rows="4" id="lokasi" name="lokasiedit" placeholder="*Nama Produk/Titik Lokasi Dijual (Marketing)" required>'.$u->lokasi_mkt.' </textarea>
									</div>
								</div>
							</div> <br>
							...
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="col-lg-10 ">
										<input class="form-control num" type="text" rows="4" id="omset" name="omsetedit" placeholder="Target Produk/Titik Dijual (Marketing)" value="'. $u->omset_mkt.'" required>
									</div>
								</div>
							</div>
							...
							<script>
								...
								//
								//added by qoqom
									$('#editbutton<?php echo $u->id ?>').on('click', function(){
										console.log('editbutton<?php echo $u->id ?>');
										var id_depart = '<?php echo $u->id_dept ?>';
										var id_parent = '<?php echo $u->id_parent ?>';
										var id_bobotedit = '<?php echo $u->id_bobot ?>';
										$('#kontenedit<?php echo $u->id ?>').val('<?php echo $u->id_bobot ?>');
										// console.log(id_parent);
										// isigoal_edit(id_bobotedit, id_depart);
										$.ajax({
										    url : "<?php echo site_url('kpimmingguannext/ambildatabobotkpim/')?>",
										    type: "POST",
										    data: {pilihdept: id_depart},
										    dataType: "JSON",
										    success: function(data)
										    { 
										    ...
										    var mydata = data;
										    $('#kontenedit<?php echo $u->id ?>').width(300);
											$("#kontenedit<?php echo $u->id ?>").select2ToTree({treeData: {dataArr:mydata}, maximumSelectionLength: 3});
										    $("#kontenedit<?php echo $u->id ?>").select2ToTree();
										    $('#kontenedit<?php echo $u->id ?>').val(id_bobotedit).trigger("change");
										    },
										    error: function (jqXHR, textStatus, errorThrown)
										    {
										        alert('Error get data from ajax');
									...
									// function isigoal_edit(id, id_depart){
		...
		<div class="modal fade" id="myModalsend" role="dialog" style="padding-top: 100px;">
			...
			<script> //ini untuk hide show table
				$(document).ready(function(){
					//konten prop disabled, added by qoqom
					$('#konten').prop('disabled','disabled');
				...
				<text style="font-family: 'Exo 2', sans-serif; font-style: italic;">
					<table style="font-family: 'Exo 2', sans-serif; ">
						...
						<tr>
							...
							<td>&nbsp; Warna Merah adalah data KPIM yang melebihi deadline goal</td>
						</tr> 
					</table>
				</text>
			</p>
		...
		<script>
			...
			$(document).ready(function(){
				$("#btn_addgoal").prop('disabled','disabled');
				$('#pilihdept').change(function(){
					$("#deadline, #btn_addgoal").prop('disabled', false);
