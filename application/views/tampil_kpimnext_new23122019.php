...
<!-- 	                <?php 
	...
	<div class="container" style="width:95%">
		<div class="background">
			<h1 style="padding-top: 20px"><center>KPIM Online - Plan Next</center></h1>
			<br><br>
			...
			$.ajax({
            	...
            	success: function(data)
                {
					...
					$.each(bulan,function(i,val){
						$bulan = val;
						$('<tr>').append($('<td class="text-left bg_bulan" colspan="7"><b>'+idnBulanTahun(val)+'</b></td>')).appendTo('#tbcontent');
						...
						$.each(hari,function(j,isi){
							...
							if($tb==$bulan){
								$hari = isi;
								$('<tr>').append($('<td class="text-left bg_hari" colspan="7"><b>'+moment(isi).locale('id').format('dddd, DD-MM-YYYY')+'</b></td>')).appendTo('#tbcontent');
