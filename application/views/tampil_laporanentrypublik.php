...
<body class="nilai semua">
	    ...
	    <div class="container-fluid"> 
	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="<?php echo base_url(); ?>/laporan/entry" >Laporan Input KPIM</a></li>
	...
	<div class="container jarak">
		...
		<center><h1 style="padding-bottom: 50px; font-weight:bold">LAPORAN INPUT KPIM SEMUA KARYAWAN</h1></center>
		...
		<table id="dataTables" class="display table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
	        <thead>
	            ...
	            <tr>
	                ...
	                <th style="text-align: center;">Alamat E-mail</th>
