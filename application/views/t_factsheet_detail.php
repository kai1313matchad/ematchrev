...
<html lang="en">
<head>
<title>Detail Factsheet Application</title>
...
Sidoarjo - East Java, 61257</p>
				...
				<div class="container">
					<div class="header-top-grids">
						<div class="agileits-logo">
							...
							<!-- <input type="text" name="jml_foto_malam" id="jml_foto_malam" value=0> -->
						</div>
						<div class="top-nav">
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header">Detail Folder <span>Factsheet </span></h3>
			<p class="agileits_dummy_para"><a href="<?php echo base_url(); ?>factsheet/laporan"><button class="btn btn-danger" style="width: 200px"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Kembali</button></a></p>
			<br><br>
		<div id="ygdiprint">
				...
				<?php $tgl = $posting->tanggal ;?>
					...
					<div class="col-md-12">
						...
						<b>
							...
							<h3 class="agileinfo_header"><?php echo $posting->reklame ?></h3>
						</b>
					   </center>
						...
						<center><h4 style=" text-transform: capitalize;"><?php echo $posting->alamat ?> </h4>
						</center>
					...
					<h4><text style="color: #0b3789">Jenis Factsheet &nbsp&nbsp:&nbsp <?php echo $posting->jenis_factsheet ?></text></h4>
					...
					<span class="album-besar sub-album borderfoto center">
							
						<a href="#" data-toggle="modal" data-target="#lightbox">
						<center>
						<div class="fotoku" name="<?php echo 'fotoku'.$foto->id ?>" id="<?php echo 'fotoku'.$foto->id ?>">
						...
						<div class="row hilangkan">
							...
							<div class="col-md-3">
							<a href="<?php echo base_url().'factsheet/lakukan_download/'.$foto->nama_foto ?>"><button class="btn btn-primary form-control" style="margin-top: 5px">Download</button></a>
							</div>
							<div class="col-md-3">
							<a href="<?php echo base_url().'factsheet/lakukan_download_asli/'.$foto->token ?>"><button class="btn btn-warning form-control" style="margin-top: 5px">Download Asli</button></a>
							</div>
							<div class="col-md-2">
								<input type="checkbox" name="<?php echo'pilih'.$foto->id ?>" id="<?php echo'pilih'.$foto->id ?>" onclick="show_pict('<?php echo $foto->id ?>')" checked>Pilih Cetak
							</div>
						</div>
...
<!-- //footer -->
	...
	function show_pict(nama)
	{
		...
		if (checkBox.checked == true){
            element.classList.remove("utkhilang");
		} else {
			element.classList.add("utkhilang");
		}
	}
	</script>
	<style>
