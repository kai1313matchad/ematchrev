...
<!-- 
				...
				<table id="dataTables" class="table table-bordered table-hover table-striped">
					...
					?>
						...
						<tr>
							...
							<td style="text-align: center; max-width: 90px; word-wrap: break-word; overflow: auto;"><?php echo $u->usulnilai ?></td>
							...
							<td style="text-align: center; background:linear-gradient(to right, #6ded68, #faffd1,  #6ded68); font-weight: bold"><?php echo round($u->actual, 2)  ?></td>
							...
							foreach ($query->result() as $key) { ?>
								<td style="text-align: center; background-color: #6ded68" >
		...
		Nilai di atas adalah nilai dari pekerjaan Dept. <?php foreach ($deptsubordinate as $i) { echo $i->nama_dept; } ?>, untuk nilai total dari keseluruhan karyawan dapat di lihat pada <a href="<?= base_url(); ?>reportkaryawan"> Halaman Report Grafik</a>.
		</div>
