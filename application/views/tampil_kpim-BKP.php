...
<!-- 					<input class="form-control jarak" rows="4" cols="20" placeholder="Nama Titik Lokasi Dijual (Marketing)" name="lokasi" id="lokasi" style="margin:0px 0 0 5px; display: none"> -->
				...
				<!--omset-->
		<!-- Update Sistem Halaman Input KPIM Mingguan (Marketing)  -->
<!-- 					<input class="form-control jarak" type="number" rows="4" cols="20" placeholder="Nilai Target Titik (Marketing)" name="omset" id="omset" style="margin:0px 0 0 5px; display: none"> -->
				</div>
...
<!-- 							<div class="row">
								...
								<div class="col-sm-8">
									<div class="col-lg-10 ">
										<input class="form-control" rows="4" id="lokasi" name="lokasiedit" placeholder="*Nama Titik Lokasi Dijual (Marketing)" value="<?php echo $u->lokasi_mkt ?>">
									</div>
								</div>
							</div> 
							...
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="col-lg-10 ">
										<input class="form-control" type="number" rows="4" id="omset" name="omsetedit" placeholder="*Nilai Target Titik (Marketing)" value="<?php echo $u->omset_mkt ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="col-lg-10 ">
										<input class="form-control" rows="4" id="klien" name="klienedit" placeholder="*Nama Klien (Marketing)" value="<?php echo $u->klien_mkt ?>">
									</div>
								</div>
							</div>
 -->
