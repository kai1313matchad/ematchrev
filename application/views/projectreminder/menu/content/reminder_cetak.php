            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 col-sm-offset-0 col-xs-offset-0">
                    <div class="panel panel-default">
                        ...
                        <div class="row">
                        <form id="ftgl" name="ftgl" action="<?php echo  base_url();?>projectreminder/reminder/cetak_tertentu2" method="post">    
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-3">
                                         ...
                                         <td>
                                               <!-- <button type="button" onclick="window.location.href='<?php echo base_url()?>projectreminder/reminder/cetak_tertentu2'" class="btn btn-default">Export to Excel</button> -->
                                               <!--<button type="submit" onclick="export_excel()" class="btn btn-default">Export to Excel</button>-->
                                         </td>
                                    </div>
                                </div>
                            </div>   
                       ...
                       <div class="row">
                        <div class="col-sm-12 col-xs-12 table-responsive">
                            ...
                            <table id="dataTables" class="table table-bordered table-hover table-striped table-responsive iki" cellspacing="0" width="100%">
                                ...
                                ?>
                                    <tr>
                                        <form name="form1" action="<?php echo base_url();?>projectreminder/Reminder/cetak_aksi/<?php echo $d->idr; ?>" method="post">
   ...
   <script>
    ...
    <script>
        ...
        {   
            dept = "";
            tanggal1 = $('[name="tanggal"]').val();
            tanggal2 = $('[name="tanggal2"]').val();
            dept = $('[name="dept"]').val();
            $.ajax({
                url : "<?php echo base_url('projectreminder/reminder/get_excel/')?>"+tanggal1+"/"+tanggal2+"/"+dept,
                type: "POST",
                data : $('#ftgl').serialize(),
                datatype : "HTML",
