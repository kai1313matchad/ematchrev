		...
		<div class="container">
			<div class="row">
                <div class="col-sm-12 col-xs-12">
                    <h4 class="page-head-line">Edit Jenis Reminder</h4>
                </div>
            </div>
            <div class="row">
                            ...
                            <table id="dataTables" class="table table-bordered table-hover table-striped table-responsive iki" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><center>Jenis Reminder</center></th>
                                ...
                                ?>
                                    <tr>
                                        <form name="form1" action="<?php echo base_url();?>projectreminder/Reminder/ubah_jenis_reminder/<?php echo $d->id; ?>" method="post">
                                        ...
                                        <a class="btn btn-danger" href="<?php echo base_url();?>projectreminder/Reminder/hapus_jenis_reminder/<?php echo $d->id; ?>">Hapus <span class="glyphicon glyphicon-trash"></span></a>
                                    </center></td>                   
                                        </form>
                                    </tr>
                                <?php } ?>
