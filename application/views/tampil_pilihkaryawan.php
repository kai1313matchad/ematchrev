...
<?php date_default_timezone_set('Asia/Jakarta'); ?>
	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
	                <!-- <li class="active"><a href="#">KPIM Report Sub - Kordinat</a></li> -->
	                		<li class="dropdown">
			                    <a href="#" class="dropdown-toggle test" data-toggle="dropdown">Penilaian - Report KPIM Mingguan (Subordinate)
			                    <span class="caret"></span>
			                    </a>
			                    <ul class="dropdown-menu"> 
			                        <li><a href="<?php echo base_url(); ?>reportsub2">Report KPIM Mingguan (Subordinate Sudah Dinilai)</a></li>
			                    </ul>
			                 </li>
	...
	<div class="container-fluid" style="max-width: 600px; background-color: gray; color: white; border:solid 4px orange; border-radius: 15px;">
		...
		<div class="row"> 
			<div class="col-sm-12 text-center" style="padding-top: 10px"><h4>Penilaian Report KPIM Mingguan (Subordinate) </h4></div>
		</div>
