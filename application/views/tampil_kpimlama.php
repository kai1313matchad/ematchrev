...
<div class="row">
								...
								<div class="col-sm-8">
									<div class="col-lg-8 ">
											...
											<div class='input-group date' id="MyDate<?php echo $u->id ?>">     
												...
												<input  type='text' value="<?php echo $u->deadline ?>" class="form-control input-group-addon" placeholder="Deadline" name="" id="deadline" disabled required> <!-- ini ditampilkan saja -->
											</div>										
									</div>
								</div>
							</div>
		...
		<div class="modal fade" id="myModalsend" role="dialog" style="padding-top: 100px;">
			...
			<div class="ini2" style="display: none"><img class="img-responsive" src="<?php echo base_url() ?>/assets/img/menilai.png" alt="Tabel menilai karyawan" title="Tabel menilai karyawan"></div>
