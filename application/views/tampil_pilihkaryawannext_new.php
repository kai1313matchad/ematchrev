	    ...
	    <div class="container-fluid"> 
	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
	                <li><a href="<?php echo base_url();?>reportsub">Penilaian - Report KPIM Mingguan (Subordinate)</a></li>	                <!-- added by qoqom -->
	                <li class="active">
			           <a href="#" class="dropdown-toggle test" data-toggle="dropdown">Approve - KPIM Plan Next (Subordinate)</a></li>
