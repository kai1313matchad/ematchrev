...
<html lang="en">
<head>
<title>Factsheet Tersimpan | Holding Center</title>
...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header"><span style="color: maroon">Factsheet</span> Tersimpan</h3>
			<p class="agileits_dummy_para">"Dapat melihat seluruh file tersimpan atau lihat file berdasarkan periode tanggal"</p>
			<br><br>
			

			<form id="form_laporan" action="<?php echo base_url();?>factsheet/laporantglterkirim" method="POST">
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-sm-6 text-center" style="padding-bottom: 15px" > <button type="submit" name="input"  class="btn btn-danger col-sm-12"><span style="color: white" class="glyphicon glyphicon-zoom-in"></span> Tampilkan File</button>
					</div>
				</div>
			</form>
			...
			<br>		
			<a href="<?php echo base_url() ?>factsheet/terkirim"><button class="btn btn-primary"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Tampilkan Semua Laporan Terkirim</button></a><br><br>
			<?php } ?>
									...
									?>
										<tr>
											...
											<td style="text-align: center; color: black">
												<form id="Detail" action="<?php echo base_url();?>factsheet/detailterkirim/<?php echo $u->id_factsheet ?>" method="POST">
